    ...
    <>
      <div className="flex flex-col lg:flex-row w-full max-h-screen z-20">
        <div className="flex flex-col gap-8 w-full lg:w-3/6 pt-16 pb-0 xl:pt-44 px-2 lg:px-16">
          ...
          <button className="flex justify-center items-end bg-green text-black text-2xl w-full lg:w-[318px] py-4 bg-opacity-80 hover:bg-opacity-100 hover:bg-black border-y border-black hover:border-y hover:border-green hover:text-green transition duration-300 z-20">
